...
pred9 = model9.predict(X_test9)

acc9 = accuracy_score(y_test9,pred9)
...
train_acc = model10.score(X_train,y_train)

test_acc = model10.score(X_test,y_test)
